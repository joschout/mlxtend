...
def class_based_association_rules(
        df,
        class_attribute_name:str,
        attribute_value_separator:str,
        metric="confidence",
        min_threshold=0.8, support_only=False,
    ...
    # attribute_value_columns = set()
    # for col in df.columns:
    #     attr_value = col.split(attribute_value_separator)
    #     attr: str = attr_value[0]
    #     if attr == class_attribute_name:
    #         attribute_value_columns.add(attr)
    #
    # print(attribute_value_columns)
    ...
    for k in frequent_items_dict.keys():
        ...
        for idx in range(len(k)-1, 0, -1):
            ...
            for c in combinations(k, r=idx):
                ...
                if len(consequent) == 1:
                    item, = consequent
                    attr_value = item.split(attribute_value_separator)
                    attr: str = attr_value[0]
                    if attr == class_attribute_name:
                        # print(attr_value)
...
def class_based_association_rules_for_all_targets(
        df,
        metric="confidence",
        min_threshold=0.8, support_only=False,
